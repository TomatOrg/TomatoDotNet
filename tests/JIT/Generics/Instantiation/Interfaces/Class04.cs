...
public class GenDouble : IGenSub<double>
{
    double Fld1;
...
public class GenString : IGenSub<String>
{
    string Fld1;
...
public class GenObject : IGenSub<object>
{
    object Fld1;
...
public class GenGuid : IGenSub<Guid>
{
    Guid Fld1;
...
public class GenConstructedReference : IGenSub<RefX1<int>>
{
    RefX1<int> Fld1;
...
public class GenConstructedValue : IGenSub<ValX1<string>>
{
    ValX1<string> Fld1;
...
public class Gen1DIntArray : IGenSub<int[]>
{
    int[] Fld1;
...
// public class Gen2DStringArray : IGenSub<string[,]>
// {
//     string[,] Fld1;
...
public class GenJaggedObjectArray : IGenSub<object[][]>
{
    object[][] Fld1;

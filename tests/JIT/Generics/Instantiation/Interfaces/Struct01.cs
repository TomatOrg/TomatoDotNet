...
public struct GenObject : IGen<object>
{
    object Fld1;
...
public struct GenGuid : IGen<Guid>
{
    Guid Fld1;
...
public struct GenConstructedReference : IGen<RefX1<int>>
{
    RefX1<int> Fld1;
...
public struct GenConstructedValue : IGen<ValX1<string>>
{
    ValX1<string> Fld1;
...
// public struct Gen2DStringArray : IGen<string[,]>
// {
//     string[,] Fld1;
...
public struct GenJaggedObjectArray : IGen<object[][]>
{
    object[][] Fld1;

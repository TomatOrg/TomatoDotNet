...
public static class Program
{
    ...
    public static int Main()
    {
        ...
        if (!TestGt1()) return 22;
        if (!TestInd1()) return 23;
        if (!TestInitObj()) return 24;
        if (!TestIntConv()) return 25;
        if (!TestJmp1()) return 26;
        if (!TestJTrue1()) return 27;
        if (!TestLe1()) return 28;
        if (!TestLeftShift()) return 29;
        if (!TestLngConv()) return 30;
        if (!TestLongArgsAndReturn()) return 31;
        if (!TestLt1()) return 32;
        if (!TestMul1()) return 33;
        if (!TestMul2()) return 34;
        if (!TestMul3()) return 35;
        if (!TestMul4()) return 36;
        if (!TestNe1()) return 37;
        if (!TestNegRMW()) return 38;
        if (!TestNestedCalls()) return 39;
        if (!TestNotAndNeg()) return 40;
        if (!TestNotRMW()) return 41;
        if (!TestOr1()) return 42;
        if (!TestOrRef()) return 43;
        if (!TestRem1()) return 44;
        if (!TestRightShiftRef()) return 45;
        if (!TestShift()) return 46;
        if (!TestStructFldAddr()) return 47;
        if (!TestStructInstMethod()) return 48;
        if (!TestSub1()) return 49;
        if (!TestSubRef()) return 50;
        if (!TestSwap()) return 51;
        if (!TestXor1()) return 52;
        if (!TestXorRef()) return 53;

...
public class CodeGenBringUpTests
{
    ...
    public static int Run()
    {
        ...
        if (!TestStructFldAddr()) return 67;
        if (!TestStructInstMethod()) return 68;
        if (!TestSub1()) return 69;
        if (!TestSubRef()) return 70;
        if (!TestSwap()) return 71;
        if (!TestUnbox()) return 72;
        if (!TestXor1()) return 73;
        if (!TestXorRef()) return 74;

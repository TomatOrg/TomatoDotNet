...
static table_parse_op_t* m_table_ops[] = {
    ...
    [METADATA_MODULE_REF] = (table_parse_op_t[]){ GET_STRING, DONE },
    [METADATA_TYPE_SPEC] = (table_parse_op_t[]){ GET_BLOB, DONE },
    [METADATA_FIELD_RVA] = (table_parse_op_t[]){ GET_RVA, GET_FIELD, DONE },
    ...
    [METADATA_FILE] = (table_parse_op_t[]){ GET_UINT32, GET_STRING, GET_BLOB, DONE },
    [METADATA_EXPORTED_TYPE] = (table_parse_op_t[]){ GET_UINT32, GET_UINT32, GET_STRING, GET_STRING, GET_IMPLEMENTATION, DONE },
    [METADATA_MANIFEST_RESOURCE] = (table_parse_op_t[]){ GET_UINT32, GET_UINT32, GET_STRING, GET_IMPLEMENTATION, DONE },

...
err_t parse_method_def_sig(blob_entry_t sig, System_Reflection_MethodInfo method, System_Type_Array typeArgs, System_Type_Array methodArgs);

err_t parse_method_ref_sig(blob_entry_t sig, System_Reflection_Assembly assembly, System_Reflection_MethodInfo* out_method, System_Type_Array typeArgs, System_Type_Array methodArgs);
